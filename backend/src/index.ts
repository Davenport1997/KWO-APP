...
app.use(async (req: AuthenticatedRequest, res, next) => {
  ...
  // CRITICAL FIX: Use the shared verifyToken middleware instead of calling Supabase directly
  // This ensures tokens generated by our /auth endpoints (using local secret) are accepted
